...
public static class SwaggerGenOptionsExtensions
{
    ...
    public static SwaggerGenOptions SwaggerDocs<TApiGroupNamesEnum>(this SwaggerGenOptions options) where TApiGroupNamesEnum : Enum
    {
        ...
        {
            if (fieldInfo.GetCustomAttribute(typeof(DocInfoGeneratorAttribute), false) is not DocInfoGeneratorAttribute openApiInfoGenerator)
            {
                throw new Exception($"{nameof(DocInfoGeneratorAttribute)} not found for {fieldInfo.Name}");
            }
